import { __values, __assign, __spreadArray, __read, __awaiter, __generator } from 'tslib';
import { isNullableType, getNullableType, isCompositeType, isAbstractType, isListType, isScalarType, isEnumType, isObjectType, GraphQLString, isInterfaceType, isSchema, isUnionType, GraphQLUnionType, GraphQLInterfaceType, defaultFieldResolver, buildASTSchema, graphql } from 'graphql';
import stringify from 'fast-json-stable-stringify';
import { mapSchema, MapperKind, getRootTypeNames } from '@graphql-tools/utils/es5';
import { addResolversToSchema } from '@graphql-tools/schema/es5';
import { mergeTypeDefs } from '@graphql-tools/merge/es5';
...
var MockStore = /** @class */ (function () {
    ...
    MockStore.prototype.generateValueFromType = function (fieldType) {
        ...
        if (isScalarType(nullableType)) {
            ...
            return __spreadArray([], __read(new Array(randomListLength()))).map(function () { return _this.generateValueFromType(nullableType.ofType); });
        }
