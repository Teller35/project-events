...
var MockStore = /** @class */ (function () {
    ...
    MockStore.prototype.generateValueFromType = function (fieldType) {
        ...
        if (graphql.isScalarType(nullableType)) {
            ...
            return tslib.__spreadArray([], tslib.__read(new Array(randomListLength()))).map(function () { return _this.generateValueFromType(nullableType.ofType); });
        }
...
function mockServer(schema, mocks, preserveResolvers) {
    ...
    if (!graphql.isSchema(schema)) {
        ...
        mySchema = graphql.buildASTSchema(merge.mergeTypeDefs(schema));
    }
    else {
        mySchema = schema;
    }
