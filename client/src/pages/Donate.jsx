      ...
      <section className="donateSection">
        <div className="donateContainer">
          <div className="donateText">
            ...
            <p>
              As EVENTS continues to grow and expand to offer more events to
              people all over the world we greatly appreciate the support that
          ...
          <div className="donateForm">
            ...
            <iframe
              title="title"
              src="https://donorbox.org/embed/e-v-e-n-t-s"
              name="donorbox"
              allowpaymentrequest=""
              seamless="seamless"
              frameborder="0"
